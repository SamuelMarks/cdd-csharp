...
| **OpenAPI Object (`jsonSchemaDialect`)** | `[x]` , `[x]` | `[ ]` , `[ ]` | `[x]` , `[x]` | Skipped or used for advanced flag validation |
| **OpenAPI Object (`servers`)** | `[x]` , `[x]` | `[ ]` , `[ ]` | `[ ]` , `[ ]` | TODO |
| **OpenAPI Object (`paths`)** | `[x]` , `[x]` | `[ ]` , `[ ]` | `[ ]` , `[ ]` | TODO |
| **OpenAPI Object (`webhooks`)** | `[x]` , `[x]` | `[ ]` , `[ ]` | `[x]` , `[x]` | Skipped (CLIs typically don't expose webhook listeners) |
...
| **Contact Object** | `[x]` , `[x]` | `[ ]` , `[ ]` | `[x]` , `[x]` | Appended to global help or skipped |
| **Contact Object (`name`)** | `[x]` , `[x]` | `[ ]` , `[ ]` | `[ ]` , `[ ]` | TODO |
| **Contact Object (`url`)** | `[x]` , `[x]` | `[ ]` , `[ ]` | `[ ]` , `[ ]` | TODO |
| **Contact Object (`email`)** | `[x]` , `[x]` | `[ ]` , `[ ]` | `[ ]` , `[ ]` | TODO |
| **License Object** | `[x]` , `[x]` | `[ ]` , `[ ]` | `[x]` , `[x]` | Appended to global help or skipped |
